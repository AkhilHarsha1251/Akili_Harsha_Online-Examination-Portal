      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5 || @$_GET['q']==6 || @$_GET['q']==7) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="dash.php?q=5">Add Test</a></li>
            <li><a href="dash.php?q=6">Remove Quiz/Test</a></li>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="right"></label>  
  <div class="col-md-12">
  <input id="right" name="right" placeholder="Enter Maximum Marks" class="form-control input-md" min="0" type="number">
